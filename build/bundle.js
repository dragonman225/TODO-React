...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _v = __webpack_require__(160);

	var _v2 = _interopRequireDefault(_v);

	var _todo_group = __webpack_require__(163);

	var _todo_group2 = _interopRequireDefault(_todo_group);

	var _todo_list = __webpack_require__(166);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'getItemIndex',
	    value: function getItemIndex(itemId) {
	      var newTodoLists = this.state.todoLists;
	      for (var i = 0; i < newTodoLists.length; i += 1) {
	        for (var j = 0; j < newTodoLists[i].list.length; j += 1) {
	    ...
	    value: function removeGroup(id) {
	      ...
	      var newTodoLists = this.state.todoLists.filter(function (item) {
	        return item.id !== id;
	      });
	      this.setState({
	    ...
	    key: 'containSameOrEmpty',
	    value: function containSameOrEmpty(name) {
	      var self = this;
	      var res = this.state.todoLists.map(function (item) {
	        return name === '' || item.name === name && item.name !== self.state.edittingGroup;
	      });
	      return res.indexOf(true) !== -1;
	    }
	  }, {
	    key: 'editGroupName',
	    value: function editGroupName(newName) {
	      var validatePass = !this.containSameOrEmpty(newName);
	      this.setState({
	    ...
	    key: 'editGroupChange',
	    value: function editGroupChange(id) {
	      var _this2 = this;

	      if (this.state.nameLegal && !this.state.edittingDetail) {
	        var edittingGroup = this.state.todoLists.find(function (item) {
	          return item.id === id;
	        });
	        var edittingGroupName = edittingGroup ? edittingGroup.name : null;
	        var newTodoLists = this.state.todoLists;
	        newTodoLists.forEach(function (item) {
	          if (item.id === _this2.state.edittingGroupId) item.name = _this2.state.newGroupName;
	        });
	        this.setState({
	          todoLists: newTodoLists,
	          edittingGroupId: id,
	    ...
	    key: 'changeList',
	    value: function changeList(groupId) {
	      if (this.state.edittingDetail) return;
	      this.setState({
	    ...
	    key: 'addItem',
	    value: function addItem(newItem, listId) {
	      console.log('[Debug]add item');
	      var newTodoLists = this.state.todoLists;
	      var targetList = newTodoLists.find(function (item) {
	        return item.id === listId;
	      });
	      var index = newTodoLists.indexOf(targetList);
	    ...
	    key: 'editItem',
	    value: function editItem(modifiedItem, itemId) {
	    ...
	    key: 'removeTodoItem',
	    value: function removeTodoItem(itemId) {
	    ...
	    key: 'checkComplete',
	    value: function checkComplete(itemId) {
	      var index = this.getItemIndex(itemId);
	      var newTodoLists = this.state.todoLists;
	      if (index[0] !== null) {
	        var c = newTodoLists[index[0]].list[index[1]].completed;
	    ...
	    value: function calculateCompleted() {
	      ...
	      for (var i = 0; i < todoLists.length; i += 1) {
	        for (var j = 0; j < todoLists[i].list.length; j += 1) {
	    ...
	    value: function render() {
	      ...
	      var s = this.state;
	      var groups = s.todoLists.map(function (item) {
	        var obj = {
	          name: item.name,
	          id: item.id
	        };
	      ...
	      var listToShow = s.todoLists.find(function (item) {
	        return item.id === s.selectedGroupId;
	      });
	      var stat = this.calculateCompleted();
	      return _react2.default.createElement(
	        'div',
	        { className: 'row' },
	        _react2.default.createElement(
	          'div',
	          { className: 'column column-25 left-bar' },
	          _react2.default.createElement(
	            'div',
	            { className: 'title' },
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement(_todo_group2.default, {
	            onItemSelect: function onItemSelect(selectedGroupId) {
	              return _this3.changeList(selectedGroupId);
	            },
	            onItemRemove: function onItemRemove(id) {
	              return _this3.removeGroup(id);
	            },
	            onEditGroupChange: function onEditGroupChange(id) {
	              return _this3.editGroupChange(id);
	            },
	            onGroupNameChange: function onGroupNameChange(newName) {
	              return _this3.editGroupName(newName);
	            },
	            groups: groups,
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'column column-75 main-area' },
	          _react2.default.createElement(_todo_list2.default, {
	            edittingDetail: function edittingDetail(val) {
	              return _this3.setState({ edittingDetail: val });
	            },
	            addItem: function addItem(item, listId) {
	              return _this3.addItem(item, listId);
	            },
	            editItem: function editItem(item, itemId) {
	              return _this3.editItem(item, itemId);
	            },
	            removeTodoItem: function removeTodoItem(itemId) {
	              return _this3.removeTodoItem(itemId);
	            },
	            checkComplete: function checkComplete(itemId) {
	              return _this3.checkComplete(itemId);
	            },
	            listObj: listToShow
	          })
	        )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _todo_group_item = __webpack_require__(164);

	var _todo_group_item2 = _interopRequireDefault(_todo_group_item);

	var _todo_add_group = __webpack_require__(165);

	var _todo_add_group2 = _interopRequireDefault(_todo_add_group);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var todoGroup = function todoGroup(props) {
	  var empty = props.groups.length === 0;
	  var error = props.showErrMsg;
	  var todoGroupItems = props.groups.map(function (item) {
	    return _react2.default.createElement(_todo_group_item2.default, {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        empty ? _react2.default.createElement(
	          'tr',
	          null,
	          _react2.default.createElement('td', { className: 'td-empty' }),
	          _react2.default.createElement(
	            'td',
	            { className: 'td-center' },
	            'No TODOs'
	    ...
	    error ? _react2.default.createElement(
	      ...
	      'WARNING: Field is empty or Name exists!'
	    ) : _react2.default.createElement('div', null),
	    _react2.default.createElement(_todo_add_group2.default, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TodoGroupItem = function TodoGroupItem(props) {
	  var p = props;
	  return _react2.default.createElement(
	    "tr",
	    null,
	    ...
	    _react2.default.createElement(
	      "td",
	      { className: "td-center", onClick: function onClick() {
	          return p.onItemSelect(p.editting ? null : p.id);
	        } },
	      p.editting ? _react2.default.createElement("input", { className: "input-custom", type: "text", value: p.newGroupName, onChange: function onChange(event) {
	          return p.onGroupNameChange(event.target.value);
	        } }) : _react2.default.createElement(
	        "span",
	        null,
	        p.name
	    ...
	    _react2.default.createElement(
	      "td",
	      { className: "td-primary", onClick: function onClick() {
	          return p.onEditGroupChange(p.editting ? null : p.id);
	        } },
	      p.editting ? _react2.default.createElement("i", { className: "fa fa-check", "aria-hidden": "true" }) : _react2.default.createElement("i", { className: "fa fa-pencil", "aria-hidden": "true" })
	    ),
	    _react2.default.createElement(
	      "td",
	      { className: "td-danger", onClick: function onClick() {
	          return p.onItemRemove(p.id);
	        } },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var todoAddGroup = function todoAddGroup(props) {
	  if (props.adding) return _react2.default.createElement("div", null);
	  return _react2.default.createElement(
	    "button",
	    { className: "btn-add", onClick: function onClick() {
	        return props.addGroup();
	      } },
	    _react2.default.createElement("i", { className: "fa fa-plus", "aria-hidden": "true" })
	  );
	};

	exports.default = todoAddGroup;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _todo_item = __webpack_require__(167);

	var _todo_item2 = _interopRequireDefault(_todo_item);

	var _todo_item_detail = __webpack_require__(168);

	var _todo_item_detail2 = _interopRequireDefault(_todo_item_detail);
	...
	var todoList = function (_Component) {
	  ...
	  _createClass(todoList, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      var update = this.props.listObj !== nextProps.listObj;
	      if (update) {
	    ...
	    key: 'startEditItem',
	    value: function startEditItem(id) {
	      this.props.edittingDetail(true);
	      var itemDetail = this.props.listObj.list.find(function (item) {
	        return item.id === id;
	      });
	      this.setState({
	        selectedItemId: id,
	    ...
	    key: 'updateDesc',
	    value: function updateDesc(d) {
	      var n = this.state.edittingItem;
	      n.description = d;
	      this.setState({
	        edittingItem: n
	      });
	    ...
	    key: 'summitEdit',
	    value: function summitEdit(isNew) {
	      var n = this.state.edittingItem;
	      if (isNew) {
	    ...
	    value: function render() {
	      ...
	      if (typeof this.props.listObj === 'undefined') {
	        todoItems = _react2.default.createElement('tr', null);
	        selectedItem = null;
	      } else {
	        var sortedList = this.sortList(this.props.listObj.list);
	        todoItems = sortedList.map(function (item) {
	          return _react2.default.createElement(_todo_item2.default, {
	            key: item.id,
	            id: item.id,
	            desc: item.description,
	            priority: item.priority,
	            completed: item.completed,
	            onTodoItemSelect: function onTodoItemSelect(selectedItemId) {
	              return _this2.setState({ selectedItemId: selectedItemId });
	            },
	            onTodoItemEdit: function onTodoItemEdit(itemId) {
	              return _this2.startEditItem(itemId);
	            },
	            onTodoItemRemove: function onTodoItemRemove(trashItemId) {
	              return _this2.props.removeTodoItem(trashItemId);
	            },
	            onCompleteCheck: function onCompleteCheck(itemId) {
	              return _this2.props.checkComplete(itemId);
	            }
	          });
	        });
	        selectedItem = this.props.listObj.list.find(function (item) {
	          return item.id === s.selectedItemId;
	        });
	      }
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h2',
	            null,
	            typeof this.props.listObj === 'undefined' ? 'No Group Selected' : this.props.listObj.name
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'column column-40' },
	            _react2.default.createElement(_todo_item_detail2.default, {
	              detail: selectedItem,
	              newDetail: this.state.edittingItem,
	              onDescChange: function onDescChange(desc) {
	                return _this2.updateDesc(desc);
	              },
	              onNoteChange: function onNoteChange(note) {
	                return _this2.updateNote(note);
	              },
	              onPriorityChange: function onPriorityChange(p) {
	                return _this2.updatePri(p);
	              },
	              ...
	              summitEdit: function summitEdit(isNew) {
	                return _this2.summitEdit(isNew);
	              }
	            })
	          )
	        )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var todoItem = function (_Component) {
	  ...
	  _createClass(todoItem, [{
	    key: 'getColor',
	    value: function getColor(priority, completed) {
	      var itemDesc = this.props.desc;
	    ...
	    value: function render() {
	      var p = this.props;
	      var color = this.getColor(p.priority, p.completed);
	      var css = {
	        borderRadius: '50%',
	        width: '4.5rem',
	      ...
	      return _react2.default.createElement(
	        ...
	        null,
	        _react2.default.createElement('td', { className: 'td-empty' }),
	        _react2.default.createElement('td', { className: 'td-indicator', style: css }),
	        p.completed ? _react2.default.createElement(
	          'td',
	          { className: 'td-checkbox', onClick: function onClick() {
	              return p.onCompleteCheck(p.id);
	            } },
	        ...
	        _react2.default.createElement(
	          'td',
	          { className: 'td-center', onClick: function onClick() {
	              return p.onTodoItemSelect(p.id);
	            } },
	          p.desc
	        ),
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'td',
	          { className: 'td-danger', onClick: function onClick() {
	              return p.onTodoItemRemove(p.id);
	            } },
	          _react2.default.createElement('i', { className: 'fa fa-times', 'aria-hidden': 'true' })
	        )
	      );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var todoItemDetail = function todoItemDetail(props) {
	  var p = props.detail;
	  var pn = props.newDetail;
	  var focus = props.isEdittingDetail;
	  var isNew = props.edittingNew;
	  var css = focus ? { transform: 'translateX(-85%)', width: '200%' } : { transform: 'translateX(0rem)' };
	  if (!p) {
	    if (!focus) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'detail-pane', style: css },
	        _react2.default.createElement(
	          'div',
	          { className: 'msg-empty' },
	          _react2.default.createElement(
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { className: 'input-custom', type: 'text', value: pn.description, onChange: function onChange(event) {
	            return props.onDescChange(event.target.value);
	          } })
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement('textarea', { className: 'input-custom', value: pn.note, onChange: function onChange(event) {
	            return props.onNoteChange(event.target.value);
	          } })
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'form',
	          null,
	          _react2.default.createElement('input', { type: 'radio', name: 'priority', value: '0', checked: pn.priority === 0, onChange: function onChange(event) {
	              return props.onPriorityChange(event.target.value);
	            } }),
	          ' High',
	          _react2.default.createElement('input', { type: 'radio', name: 'priority', value: '1', checked: pn.priority === 1, onChange: function onChange(event) {
	              return props.onPriorityChange(event.target.value);
	            } }),
	          ' Medium',
	          _react2.default.createElement('input', { type: 'radio', name: 'priority', value: '2', checked: pn.priority === 2, onChange: function onChange(event) {
	              return props.onPriorityChange(event.target.value);
	            } }),
	          ' Low'
	        )
	...
	exports.default = todoItemDetail;
